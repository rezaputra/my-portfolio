                    ...
                    >
                        ...
                        <motion.div className=" hidden md:flex xl:text-lg max-w-2xl" variants={itemVarian}>
                            <p className=" font-sans ">
                                The individual is self-independent, reliable, friendly, and adaptable, excelling in both
                                team and independent work, while swiftly learning new technologies and staying
                                organized.
                            </p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            variants={itemVarian}
                        >
                            <Link download={"resume.pdf"} href={"/resume.pdf"} target="_blank">
