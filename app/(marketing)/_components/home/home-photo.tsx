        ...
        <div className=" flex w-full md:w-max  justify-center">
            ...
            >
                <Image
                    ...
                    width={390}
                    alt="Home-photo"
                    className=" w-[180px] md:w-[280px] lg:w-[350px] xl:w-[460px] h-auto shadow-md rounded-sm lg:rounded-es-none"
                    priority={true}
                />
                <div className="relative block bg-primary origin-right">
                    <AnimatePresence>
                        <motion.div
                            className="flex absolute z-0 items-center px-4 h-8 md:h-10 lg:h-12 xl:h-14 space-x-2 bottom-0 md:left-0 lg:left-[-230px] w-full lg:w-[230px] justify-center lg:origin-right bg-zinc-950 origin-right rounded-b-sm lg:rounded-b-none lg:rounded-l-sm"
