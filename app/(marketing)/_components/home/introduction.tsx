...
export function Introduction() {
    ...
    return (
        <motion.div
            ...
            animate="visible"
        >
            <motion.h4 className=" text-lg md:text-xl lg:text-2xl" variants={item}>
                Hello, I’m
            </motion.h4>
            <motion.h1 className="text-3xl md:text-5xl lg:text-6xl font-semibold" variants={item}>
                Reza
                <br />
                Mardiansyah <br />
                Putra
            ...
            <motion.h4 className="  md:text-xl lg:text-2xl text-muted-foreground truncate" variants={item}>
                Fullstack Developer & Data Scientist
            </motion.h4>
            <motion.div className=" space-x-1 md:space-x-2" variants={item}>
                <TooltipProvider>
            ...
            {isScrolled && (
                <motion.div transition={{ duration: 1 }} variants={item}>
                    <Link href={"#contact"}>
                        <motion.button
