        ...
        <div className=" w-full md:w-max flex  justify-center">
            ...
            >
                <Image
                    ...
                    width={390}
                    alt="Home-photo"
                    className=" w-[200px] md:w-[300px] lg:w-[470px] h-auto"
                    priority={true}
                />
                <div className="relative flex bg-primary ">
                    <AnimatePresence>
                        <motion.div
                            className="absolute flex items-center px-4  h-8  md:h-10 lg:h-12 space-x-2 bottom-0 md:left-0 lg:left-[-230px] w-[200px] md:w-full lg:w-[230px] justify-center lg:origin-right bg-primary"
