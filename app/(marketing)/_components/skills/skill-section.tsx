            ...
            <SectionContent className="">
                <div ref={ref} className=" lg:flex justify-center md:gap-x-6 lg:gap-x-10 xl:gap-x-14 h-full">
                    ...
                    >
                        ...
                        <p className="lg:text-base xl:text-lg font-sans text-muted-foreground text-wrap">
                            My passion is driving innovation and effecting positive change through technology.
                            Let&apos;s collaborate to engineer solutions that redefine the digital landscape and create
