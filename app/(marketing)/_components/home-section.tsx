...
function HomeSection() {
    return (
        ...
        >
            <SectionContent className="container md:flex items-center justify-center md:justify-between  mt-0 md:mt-0 lg:mt-0 xl:mt-0 space-y-4 md:space-y-0  md:space-x-10 lg:space-y-0 px-[10%] lg:px-[8%] xl:px-[6%]">
                <div>
                    <HomeIntroduction />
                </div>
                <div>
